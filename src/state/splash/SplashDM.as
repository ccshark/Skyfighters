package state.splash
{
	...
	import state.gameStates.GameStateDm;
	
	public class SplashDM extends DisplayState
	{
		 ...
		 * Bakgrundsbild.
		 */
		[Embed(source="../../../asset/png/splash/DM_HTP_GFX.png")]
		...
		private function startMenu():void {
			Session.application.displayState = new GameStateDm(2);
		}
	}
}
