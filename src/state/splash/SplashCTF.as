package state.splash
{
	...
	import state.gameStates.GameStateCtf;
	
	public class SplashCTF extends DisplayState
	{
		 ...
		 * Bakgrundsbild.
		 */
		[Embed(source="../../../asset/png/splash/CTF_HTP_GFX.png")]
		...
		private function startMenu():void {
			Session.application.displayState = new GameStateCtf(2);
		}
	}
}
